  ...
  return (
    <div className="view-wrapper space-y-6" dir="rtl">
      ...
      {tab === 'cash' && <div className="space-y-6">
        ...
        <Card title="Customer Credit Refunds" subtitle="استردادات الالتزام منفصلة عن التحصيل النقدي والتطبيق على الفواتير" headerIcon={<WalletCards className="w-5 h-5" />} data-testid="customer-credit-refunds-section">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4" data-testid="customer-credit-reporting-summary">
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-3"><p className="text-[11px] font-bold text-amber-800">Customer Credit liability</p><p className="text-lg font-black text-amber-800">{money(customerCreditLiability)}</p></div>
            <div className="rounded-xl border border-rose-200 bg-rose-50 p-3"><p className="text-[11px] font-bold text-rose-800">Cash refunds</p><p className="text-lg font-black text-rose-800">{money(customerCreditCashRefunds)}</p></div>
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3"><p className="text-[11px] font-bold text-slate-700">Non-cash refunds</p><p className="text-lg font-black text-slate-900">{money(customerCreditNonCashRefunds)}</p></div>
          </div>
